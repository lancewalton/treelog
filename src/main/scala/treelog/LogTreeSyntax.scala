...
trait LogTreeSyntax[Annotation] {
   ...
   * description.
   */
  def success[V](value: V): DescribedComputation[V] = eitherWriter.right(value)
  ...
  type SerializableDescribedComputation[V] = Tuple2[\/[String, V], SerializableTree[Annotation]]
